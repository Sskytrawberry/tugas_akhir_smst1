...
@push('styles')
<link rel="stylesheet" href="{{ asset('css-sp/profile.css')}}">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" integrity="sha512-5A8nwdMOWrSz20fDsjczgUidUBR8liPYU+WymTZP1lmY9G6Oc7HlZv156XqnsgNUzTyMefFTcsFH/tnJE/+xBg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
@endpush

@section('content')
<div class="relative w-full overflow-hidden">
  <img class="block w-full h-screen object-cover " src="{{ asset('images/pastry-baker.jpg')}}">
</div>
  ...
  <div class="container2 rounded-3xl mt-24 grid grid-cols-2 gap-9 p-9 order-last mx-10" style="background-color: #FFC6C6;">
    ...
    <div class="teks flex justify-center items-center order-first ">
      <img src="{{asset('images/visi.jpg')}}" class="block rounded-xl" style="max-width: 90%; max-height: 100%;" alt="">
    </div>
  </div>

<div class="misi">
  <h1 class="text-5xl text-white mb-6 flex justify-center items-center">MISI</h1>
