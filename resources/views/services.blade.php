    ...
    <section class="mx-24">
        <div class="grid grid-cols-2 gap-4 h-screen w-full">
            <div class="flex justify-center items-center h-full">
                <img src="{{ asset('images/outlet-services.png') }}" class="block ml-6" style="max-width: 90%; max-height: 100%;" alt="">
            </div>
        ...
        <div class="container2 rounded-3xl mt-24 grid grid-cols-2 gap-9 p-9 order-last" style="background-color: #FFC6C6;">
            ...
            <div class="flex justify-center items-center h-full">
                <img src="{{asset('images/catering_services.jpg')}}" class="block ml-6" style="max-width: 90%; max-height: 100%;" alt="">
            </div>
        ...
        <div class="flex justify-center items-center h-full">
                <img src="{{asset('images/delivery_service.jpg')}}" class="block ml-6" style="max-width: 90%; max-height: 100%;" alt="">
            </div>
        ...
        <div class="flex justify-center items-center h-full">
                <img src="{{asset('images/internal_service.jpg')}}" class="block ml-6" style="max-width: 90%; max-height: 100%;" alt="">
            </div>
